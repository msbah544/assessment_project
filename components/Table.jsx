          ...
          <thead>
            <tr className="border-y">
              {tableData?.cols?.map((col) => (
                <td key={col} className="py-4 px-4 font-semibold ">
                  {col}
                </td>
              ))}
            </tr>
                  ...
                  >
                    {item == "Refund" || "Not Refund" ? (
                      <span
                        className={`${
                          item == "Refund" &&
                          " bg-green-100 py-1 px-4 border border-green-500 rounded-lg text-green-500 font-semibold"
                        } ${
                          item == "Not Refund" &&
                          "bg-red-100 py-1 px-4 border border-red-500 rounded-lg text-red-500 font-semibold"
                        }`}
                      >
                        {item == "Casual..." ? (
